...
torchrun --nproc_per_node=1 --rdzv_backend=c10d --rdzv_endpoint=$MASTER_ADDR:$MASTER_PORT train.py  \
    --data "/mmfs1/home/dmiller10/EE800 Research/Data/Faster-RCNN/25%/data_configs/data.yaml" \
    --epochs 300 \
    --resume-training \
    --weights ./outputs/training/25%_Faster_RCNN_v2_p30/last_model.pth \
    --model fasterrcnn_resnet50_fpn_v2 \
    --name 25%_Faster_RCNN_v2_p30 \
    --batch 8 \
    --imgsz 1920 \
    --patience 50 \
    --disable-wandb
