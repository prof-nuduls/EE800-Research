...
class LogJSON():
    ...
    def update(self, image, file_name,scores, boxes, labels, classes,height_r,width_r):
        """
        ...
        for box,score, label in zip(boxes,scores, labels):
            ...
            annotation = {
                ...
                "image_id": file_name,
                "score": float(score),
                "bbox": [int(xmin/width_r*image_info['width']), int(ymin/height_r*image_info['height']), int(width/width_r*image_info['width']),int(height/height_r*image_info['height'])],
                "area": width * height,
                "category_id": label,
                "iscrowd": 0
            }
