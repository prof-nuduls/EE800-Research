...
python inference.py  --data "/mmfs1/home/dmiller10/EE800 Research/Data/Faster-RCNN/+90k/data_configs/data.yaml" \
--input /mmfs1/home/dmiller10/EE800\ Research/Data/SeaDronesSee\ Object\ Detection\ v2/Uncompressed\ Version/Test/images \
--model fasterrcnn_resnet50_fpn_v2 --weights ./outputs/training/+90k_Faster_RCNN_v2_p30/best_model.pth \
