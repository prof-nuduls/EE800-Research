...
# Sampling dictionary for 0%, 25%, 50%, 75%, and 100%
sampling_dict = {
    "0%": (8000, 0),      # 8000 real, 0 synthetic
    "25%": (6000, 2000),  # 6000 real, 2000 synthetic
    "50%": (4000, 4000),  # 4000 real, 4000 synthetic
    "75%": (2000, 6000),  # 2000 real, 6000 synthetic
    "100%": (0, 8000)     # 0 real, 8000 synthetic
}
...
def process_folder(task):
    folder_name, real_count, synth_count = task
    ...
    real_train_images = sample_files(source_real_train_images, real_count)
...
if __name__ == "__main__":
    tasks = [(folder_name, real_count, synth_count) for folder_name, (real_count, synth_count) in sampling_dict.items()]
