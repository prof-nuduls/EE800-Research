...
python inference.py  --data "/mmfs1/home/dmiller10/EE800 Research/Data/Faster-RCNN/{folder}/data_configs/data.yaml" \\
--input /mmfs1/home/dmiller10/EE800\ Research/Data/SeaDronesSee\ Object\ Detection\ v2/Uncompressed\ Version/Test/images \\
--model fasterrcnn_resnet50_fpn_v2 --weights ./outputs/training/{folder}_Faster_RCNN_v2_p30/best_model.pth \\
--imgsz 1920 --output ./test_results --log-json"""

# Loop through each folder and write the Train_RCNN.sh file
for folder in folders:
    folder_path = os.path.join(base_dir, folder)
    file_path = os.path.join(folder_path, "Test_RCNN.sh")
